...
#import "SoundTouchAVAssetPlayer.h"
#include <SoundTouch/SoundTouch.h>

@interface SoundTouchAVAssetPlayer() {
...
@implementation SoundTouchAVAssetPlayer

- (id)init {
    self = [super init];
    if (self) {
        [self setupSoundTouch];
        self.filteringCallback = ^(AudioAssetPlayer *player, char *srcBuffer, UInt32 srcBytesAvailable, char *dstBuffer, UInt32 dstBufferCapacity, UInt32 *dstBytesWritten) {
